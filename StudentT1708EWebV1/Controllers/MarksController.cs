...
namespace StudentT1708EWebV1.Controllers
{
    public class MarksController : Controller
    {
        private readonly StudentT1708EWebV1Context _context;
        ...
        {
            var studentT1708EWebV1Context = _context.Mark.Include(m => m.Student);
            return View(await studentT1708EWebV1Context.ToListAsync());
        }
